...
lastmod = 2021-07-13T21:17:11+05:45
...
## A [perceptron](20210224173929-perceptron.md) is a simple neural network {#a-perceptron--20210224173929-perceptron-dot-md--is-a-simple-neural-network}
...
-   **delta rule** uses [gradient](2021-05-30--08-53-22Z--gradient.md) descent to search the hypothesis space \\(H\\) to find the best weights for our training examples.
...
-   \\(o\_{d}\\) is output from linear unit, unthresholded
    -   for [perceptron](20210224173929-perceptron.md) \\(o\_{d} = sgn(\overrightarrow{w}.\overrightarrow{x})\\), where,
...
-   To modify the gradient descent algorithm shown in _Figure [6](#org8d170f3)_ to implement this stochastic approximation, Equation (T4.2) is simply deleted and Equation (T4.1) replaced by,
...
### [Sigmoid](2021-05-22--10-42-02Z--activation_function.md) unit {#sigmoid--2021-05-22-10-42-02z-activation-function-dot-md--unit}

-   output is a non linear function of its inputs and is differentiable threshold function
-   [Tanh](2021-05-22--10-42-02Z--activation_function.md) is also used in place of the sigmoid
...
-   Hypothesis space is continuous, in contrast to the hypothesis spaces of [decision tree](2021-06-03--11-01-27Z--decision_tree.md) learning and other methods based on discrete representations.
...
-   [Inductive Bias](2021-06-03--11-07-01Z--inductive_bias.md)
...
-   How many weight-tuning iterations should the algorithm perform?
    ...
    -   We can try [Early Stopping](2021-05-26--11-28-39Z--regularization.md)
...
-   \\( \sum\_{i,j} w\_{ji} ^2 \\)  is the [regularization](2021-05-26--11-28-39Z--regularization.md) term
...
## Recurrent Networks([RNN](20210213135051-recurrent_neural_networks.md)) {#recurrent-networks--rnn-20210213135051-recurrent-neural-networks-dot-md}
